...
//!
//! Nothing in `kyma-connectors`' internals — the runner, the scheduler, the
...
// ── Trait + lifecycle ────────────────────────────────────────────────────────
pub use kyma_connectors::types::{
    ConfigError, Connector, ConnectorCtx, ConnectorError, ConnectorRun, DriveModel, GraphHint,
    TableRows,
};

// ── Self-describing catalog ──────────────────────────────────────────────────
pub use kyma_connectors::catalog::{CatalogEntry, CatalogField, CatalogResource};

// ── Graph-row helpers ────────────────────────────────────────────────────────
pub use kyma_connectors::graph_row::{normalize_edge, normalize_node};
