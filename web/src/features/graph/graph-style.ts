 ...
 * helpers, and level-of-detail thresholds. Kept separate from graph-layout.ts
 * (pure geometry) and aligned with src/lib/data-palette.ts so the graph reads
 * as part of the same visual system as charts/badges.
 */
