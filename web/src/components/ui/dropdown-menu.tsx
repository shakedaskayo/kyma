...
>(({ className, sideOffset = 6, ...props }, ref) => (
  <DropdownMenuPrimitive.Portal>
    <DropdownMenuPrimitive.Content
      ...
      className={cn(
        "glass z-50 min-w-[10rem] overflow-hidden rounded-md p-1 text-popover-foreground",
...
>(({ className, ...props }, ref) => (
  <DropdownMenuPrimitive.SubContent
    ref={ref}
    className={cn("glass z-50 min-w-[8rem] overflow-hidden rounded-md p-1 text-popover-foreground", className)}
    {...props}
  />
));
