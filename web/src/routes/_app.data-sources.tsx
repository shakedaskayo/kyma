...
// Layout route for /data-sources. The list lives in
// `_app.data-sources.index.tsx`, the detail in `_app.data-sources.$id.tsx`,
// and the section tabs (watchers/sync/memories) in their sibling routes; all
// render through this Outlet under the shared header + tab bar.
            ...
            <div className="flex items-center gap-2.5">
              ...
              <div className="leading-tight">
                ...
                <p className="text-2xs text-muted-foreground">
                  Everything feeding the context graph — sources, file watchers, and memory sync.
                </p>
              </div>
            </div>
          </div>
