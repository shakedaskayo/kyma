...
export PENSIEVE_STAGING_DISABLED=1    # one-extent-per-ingest for deterministic pruning metrics
...
LOG_FILE="/tmp/pensieve-graph.log"
SERVER_PID=""
...
./target/debug/pensieve-cli create-table --db default --name calls \
